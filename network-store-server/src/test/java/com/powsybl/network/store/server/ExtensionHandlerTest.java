...
class ExtensionHandlerTest {
    ...
    void createExtensionsTest() {
        ...
        extensionHandler.createExtensions(map1);
    ...
    void getExtensionsTest() {
        ...
        extensionHandler.createExtensions(Map.of(infoBattery1, extensionAttributesBattery1));
        ...
        Map<String, ExtensionAttributes> extensionAttributesBattery2 = Map.of("activePowerControl", ActivePowerControlAttributes.builder().droop(5.0).participate(false).participationFactor(0.5).build(),
                "operatingStatus", OperatingStatusAttributes.builder().operatingStatus("test23").build());
        extensionHandler.createExtensions(Map.of(infoBattery2, extensionAttributesBattery2));
        ...
        extensionHandler.createExtensions(Map.of(infoGenerator1, extensionAttributesGenerator1));
    ...
    void updateExtensionsFromNetworksTest() {
        ...
        Map<String, ExtensionAttributes> extensionAttributesNetwork1 = Map.of("activePowerControl", ActivePowerControlAttributes.builder().droop(6.0).participate(true).participationFactor(1.5).build(),
                "operatingStatus", OperatingStatusAttributes.builder().operatingStatus("test12").build());
        extensionHandler.createExtensions(Map.of(infoNetwork1, extensionAttributesNetwork1));
    ...
    void insertNonPersistentExtensionTest() {
        ...
        extensionHandler.createExtensions(Map.of(infoBattery, extensionAttributes));
