...
class TwoWindingsTransformerIT extends AbstractTwoWindingsTransformerTest {
    @Disabled("waiting the release containing this PR: https://github.com/powsybl/powsybl-core/pull/3019")
    @Test
    @Override
