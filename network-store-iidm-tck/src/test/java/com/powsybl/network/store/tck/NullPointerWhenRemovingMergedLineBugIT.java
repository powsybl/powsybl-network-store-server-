...
class NullPointerWhenRemovingMergedLineBugIT extends AbstractNullPointerWhenRemovingMergedLineBugTest {
    @Disabled("network merge isn't implemented")
    @Override
    @Test
    public void test() {
        // FIXME remove this test when network merge is implemented
        super.test();
    }
}
